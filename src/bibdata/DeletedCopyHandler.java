 ...
 * @author thoeyeth
 */
public class DeletedCopyHandler extends DefaultHandler {
	...
	map.put("BB-nummer", "BBnr");
	map.put("Barcode", "id");
	map.put("PK", "PK");
	map.put("Afvoerdatum", "datumafvoer");
    ...
    public DeletedCopyHandler(File file) {
	...
	this.cnt = "";
	this.rid = 0;
	this.fc = new JFileChooser(BibdataFrame.START_DIR);
	...
	if (localName == "DeletedObjectsTitleData.Record") {
	    this.rid++;
